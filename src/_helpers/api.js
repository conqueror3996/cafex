...
export const allAPI = {
    ...
    delete_consumers_by_id: (consumerId) => `${REST_ENDPOINT}v1/consumers/${consumerId}`, // Ap010304_顧客削除API
    update_consumers_by_id: (consumerId) => `${REST_ENDPOINT}v1/consumers/${consumerId}`, // Ap010305_顧客更新API
